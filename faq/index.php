...
<head>
    ...
    <title>FAQ | Yacht Rental System</title>
</head>
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Yacht Rental Systems gladly accepts Mastercard and Visa. Personal Checks are also accepted providing you purchase CDW and Theft Protection on your rental.
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">What if i find a better rate for a rental yacht?</a>
                    <div class="cd-faq-content">
                        <p>One of the many great things about Yacht Rental System is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rental yacht fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Will i need a driving license to rent a yacht?</a>
                    <div class="cd-faq-content">
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if i return the yacht after the due date?</a>
                    <div class="cd-faq-content">
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Yacht Rental System gladly accepts MasterCard, Visa, and checks. We also PayTm.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
