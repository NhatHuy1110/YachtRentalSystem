...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM rentedyachts ry, yachts y
    WHERE ry.customer_username='$login_customer' AND y.yacht_id=ry.yacht_id ";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any yachts till now!</h1>
        <p class="text-center"> Please rent yachts in order to view your data here. </p>
      </div>
    </div>
