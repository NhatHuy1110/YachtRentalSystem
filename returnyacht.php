    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Marina <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="returnyacht.php">Return Now</a></li>
...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT y.yacht_name, y.yachttype_id, ry.rent_start_date, ry.rent_end_date, ry.fare, ry.charge_type, d.driver_name, d.driver_phone
 FROM rentedyachts ry, yachts y, driver d
 WHERE id = '$id' AND y.yacht_id=ry.yacht_id AND d.driver_id = ry.driver_id";
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Yacht:&nbsp;  <?php echo($yacht_name);?></h5>

           <h5> Yacht Number:&nbsp;  <?php echo($yachttype_id);?></h5>
          ...
          <?php if($charge_type == "hour") { ?>
          <div class="form-group">
            <input type="text" class="form-control" id="hour_or_days" name="hour_or_days" placeholder="Enter the time travelled (in hour)" required="" autofocus>
          </div>
          <?php }  else { ?>
            <h5> Number of Day(s):&nbsp;  <?php echo($no_of_days);?></h5>
            <input type="hidden" name="hour_or_days" value="<?php echo $no_of_days; ?>">
          <?php } ?>
